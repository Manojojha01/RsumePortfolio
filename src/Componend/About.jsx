    ...
    <div className='bg-black text-white py-20 ' id='about'>
        <div className="container mx-auto px-8 md:px-16 lg:px-24">
            ...
            <div className="flex flex-col md:flex-row items-center md:space-x-12">
                <img className='w-72 h-80 rounded object-cover mb-8 md:mb-0'
                 src={aboutme} alt="" />
               <div className='flex-1'> <p className='text-lg  mb-8'>
                    I am a passionate full-stack devloper with a focus on buliding 
                    morder and responsive web appplictions. with a strong foundation
                    in both fornted and backend technologies, I strive to create
                seamkess and efficient user experiences.
                </p>
